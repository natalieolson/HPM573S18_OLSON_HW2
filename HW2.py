constant = 0.371
coefficient = 1.371
#Dictionary Set-up for variables
...
#indicate position in list for each variable as -1 because otherwise Python labels the first number in a list as 0
